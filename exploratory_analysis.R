# ANALYSIS OF EYE-TRACKING DATA 3: Exploratory analysis
# Measures: Selective Regression Path, First Pass Regression, Total Duration Fixation and First-pass Duration
# Languages: Catalan and English
# Structures: RC (object vs. subject RCs)
...
# Read RC parquet file
rc <- read_parquet("rc_long_filtered.parquet")
#Set working directory to the script's location
setwd (dirname(rstudioapi::getActiveDocumentContext()$path))

# PART 1. Metrics: Selective regression path and first-pass regression.
# STEP 1: MERGE RC PARQUET FILE WITH EXCEL ROIS 
# Load Excel
...
# STEP 2: FIX NAMING INCONSISTENCIES + EXTRACT INFORMATION
...
# STEP 3: CALCULATING REGRESSION METRICS + DESCRIPTIVE PLOTS 
...
#STEP 4: NORMALISE + STATISTICAL MODELS REGRESSIONS
...
# PART 2. Metrics: First-pass duration and total duration fixations.
# STEP 1: LOAD EXCEL WITH THE REGIONS TO CALCULATE THE METRICS
...
# STEP 2: DESCRIPTIVE PLOTS
# Descriptive summaries to use for the plots
...
# STEP 3: NORMALISE + STATISTICAL MODELS
# Narmalise data
